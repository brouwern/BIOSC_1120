...
### Pre-requisites
The general pre-requities for this course are: completion of 1 year of intro biology, 1 upper divion bio course, and an intro stats course.  Specifically: 
...
Reading the *Reading Guide* is not required but is highly recommended.  Content from yor reading assignments will be integrated into the Guide and suggestions for making it a useful resource are highly welcome.
...
This course will rely heaving on online materials, including online open-access materials I have written for the course, online R communities, and social media.  Use of Twitter will be required for some assignments.
...
* [R for Ecological Data Science](https://github.com/brouwern/BOOK_R_Ecological_Data_Science): https://github.com/brouwern/BOOK_R_Ecological_Data_Science
  - This is the primary workbook and lab manual for the R exercies
* A [Reading Guide to Motulsky's Intuitive Biostatistics](https://brouwern.github.io/IBSguide/): https://brouwern.github.io/IBSguide/
...
* wildlifeR: https://brouwern.github.io/wildlifeR/
  - datasets & exercies related to wildlife ecology
* abdcompanion: https://github.com/brouwern/abdcompanion
...
Students will be evaluated through participation, weekly pre-class assignments, problem sets, group projects, and an independent project related to their own work.  Each element is summarized below.  See the attached table for a breakdown of the points and the individual assignment handouts for further details.

#### In-class Participation

Attendance is required for all class sessions and students are required to stay for the entire session.  Attendance will be recorded.  If you cannot attend a class or must leave early due to special circumstances please contact me in advance if possible so we can make plans for you to complete the necessary work.

#### Required office hours

Students are required to meet with the professor at least twice to discuss their progress in the course and/or how the course relates to other aspects of their studies or research.  This can be done during office hours or over lunch or coffee.  If necessary it can be done over the phone or Skype.  Upon approval extensive email conversation can substitute for one meeting.

#### Weekly pre-class assignments

Coming prepared is essential for making class time as productive as possible.  **Students must read all assigned readings.**  Additinally, pre-class assignments will typically be assigned.  Assignments will be typically be based on chapters from the assigned text, *Intuitive Biostatistics.*  These assignments are summarized below.  See the individuals handouts for further details.

##### Reading-reinforcement assignments (RRAs)

Most weeks students will be required to complete an assignment to help you engage with and extend the concepts discussed in the course text *Intutive Biostatistics*.  These assignments should generally be easy to complete while reading the book and students will be able to select from different options that best suit their interests.  Two of these assignments, however, will require some research and writing.  See the **Reading reinforcement assignments** handout.  

##### Pre-lab Computation Tutorials & Computation Challenges

For several chapters of *Intuitive Biostatistics* I will create a visual walthrough which demonstrates how to carry out the major computations in a spreadsheet program and/or R.  I will also create a short spreadsheet-based computation exercise similar to the example in the book.  Students must complete the computation tutorials prior to class and ideally begin the computation challenges.  A **pre-lab computation worksheet** will be provided that must be turned in prior to the begining of class.  Students can  chose to finish the computation exercises in class and complete them on their own time.  A **post-lab computation worksheet** will then be turned in.  Computation exercises will cover:

* Bionomial confidence intervals (IBS: Ch 4)
...
Most weeks extensive time will be spent in-class working on tutorials in R.  Each tutorial will have an accompanying worksheet.  Students will have one week from when it was begun to complete these worksheets.

#### Social media assignment

Be a follower
Tweet useful material (eg, your assignments)
Ask a question
Answer a question
...
* Email from me to you:  You must check your email regularly.  If you use a personal email address please arrange to have your univeristy emails forwarded there.  For example, I have my University email forwarded to my main email address, brouwern@gmail.com.  I will try to include BIOSTATSS in the subject.
...
If an exam is missed it is the responsibility of the student to notify the instructor. If extenuating circumstances exist, exams can be made up at a later date chosen at the instructors discretion. 
...
Please consult the University calendar for withdrawl dates.

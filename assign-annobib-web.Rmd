...
* [__] Read the assigned chapter in Intuitive Biostatistics
* [__] Identify a particular topic or method in  the assigned chapter (eg, multiple comparisons or 2-sample t-tests)
* [__] Find a web-based resource that you find interesting and readable related to the topic.
* [__] Write out the full reference information for the resource, including title, author (if known), and URL
* [__] Write a 150-200 word annotated bibliography entry which:
  + [__] Briefly summarizes the method or topic as presented by Motulsky in the chapter
  + [__] Summarizes the topic as presented by resource you found
  + [__] Points out any differences between them, or how the reference you selected is an extension.
  + [__] Indicates who might find this resource most useful, eg "Someone struggling with R" or "Cell biologists confused by P-values."
  + [__] Indicate if this resource would be useful for future students in this class or would be more appropriate for more advanced students.

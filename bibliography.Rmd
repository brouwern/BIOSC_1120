...
* = Strongly suggested reading for independent project.

No asterisk: suggested, or mentioned in class.


### Week 7: T-tests & effect sizes

* Anon.  Codebook cookbook: A guide to writing a good codebook for data analysis projects in medicine.  [McGill University.](http://www.medicine.mcgill.ca/epidemiology/joseph/pbelisle/CodebookCookbook/CodebookCookbook.pdf)
...
* *Broman, KW and K Woo.  2018. Data organization in spreadsheet.  [The American Statistician.](https://doi.org/10.1080/00031305.2017.1375989)
    + Highly recommended reading for understanding tidy data and data dictionaries
...
* **Walker, J.  2018a.  [Combining data, distribution summary, model effects, and uncertainty in a single plot.](www.middleprofessor.com/files/quasipubs/harrell_plot_intro.html)  
    + Excellent discussion about why we should think in terms of effect sizes.
    + Fig. 2 in the blog currently isn't shown, but can be seen at Walker (2018b) and page 6 of Harrel(nd)
...
Parker et al.  2019.  Empowering peer reviewers with a checklist to improve transparency.  [Nature Ecology & Evolution.](https://www.nature.com/articles/s41559-018-0545-z)
